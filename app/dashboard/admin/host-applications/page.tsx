...
const HostApplicationsPage = async () => {
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-10">
      <div>
        <h1 className="text-3xl font-black text-[var(--text-primary)]">Host Applications</h1>
        <p className="text-sm text-[var(--text-secondary)]">Review and approve player requests to become hosts.</p>
      </div>
